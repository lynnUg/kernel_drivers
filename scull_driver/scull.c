...
static void scull_create_proc(void)
{
  ...
  if (!entry) {
    printk(KERN_ALERT "Your proc create just failed , headache");
     }
}
                ...
                loff_t *f_pos)
{
  ...
  *f_pos += count;
  ...
  out:
    up(&dev->sem);
    printk(KERN_ALERT "Sempahore headache err day!!");
    return retval;
}
                ...
                loff_t *f_pos)
{
  ...
  *f_pos += count;
  ...
  out:
    up(&dev->sem);
    printk(KERN_ALERT "Sempahore headache");
    return retval;
}
